# Rails application template for engine-rubygems host app
# Usage: rails new rails_app -m template/template.rb

gem "engine-rubygems", path: "../../engine/engine-rubygems", require: "engine_rubygems"
...
# Mount the engine
route <<~ROUTES
  mount EngineRubygems::Engine, at: "/rubygems"

  # LLM health-check endpoint
  mount LlmEngine::Engine, at: "/llm" if defined?(LlmEngine)
ROUTES

# Configure production to accept all hosts
